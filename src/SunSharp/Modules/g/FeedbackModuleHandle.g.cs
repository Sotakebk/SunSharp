...
namespace SunSharp.Modules
{
    ...
    public readonly partial struct FeedbackModuleHandle : IFeedbackModuleHandle
    {
        ...
        /// <inheritdoc cref="IFeedbackModuleHandle.GetVolume(ValueScalingMode)" />
        public int GetVolume(ValueScalingMode valueScalingMode = ValueScalingMode.Displayed) => ModuleHandle.GetControllerValue(0, valueScalingMode);

        /// <inheritdoc cref="IFeedbackModuleHandle.SetVolume(int, ValueScalingMode)" />
        public void SetVolume(int value, ValueScalingMode valueScalingMode = ValueScalingMode.Displayed) => ModuleHandle.SetControllerValue(0, value, valueScalingMode);

        /// <inheritdoc cref="IFeedbackModuleHandle.MakeVolumeEvent" />
        ...
        /// <inheritdoc cref="IFeedbackModuleHandle.SetChannels(Channels)" />
        public void SetChannels(Channels value) => ModuleHandle.SetControllerValue(1, (int)value, ValueScalingMode.Displayed);

        /// <inheritdoc cref="IFeedbackModuleHandle.MakeChannelsEvent" />
