    ...
    public class SunVoxLibExtensionsTests
    {
        ...
        private static IEnumerable<TestCaseData> PrepareRunInLockActionCalls()
        {
            yield return new TestCaseData(
                0,
                static (ISunVoxLib lib, Action<object[]?> action, object[]? _) =>
                {
                    lib.RunInLock(0, () => action(null));
                }
            );
            yield return new TestCaseData(
                1,
            ...
            yield return new TestCaseData(
                ...
                {
                    ArgumentNullException.ThrowIfNull(args);
                    lib.RunInLock(0, (arg1, arg2, arg3, arg4) => action(new[] { arg1, arg2, arg3, arg4 }), args[0], args[1], args[2], args[3]);
                }
            );
            yield return new TestCaseData(
                5,
                ...
                {
                    ArgumentNullException.ThrowIfNull(args);
                    lib.RunInLock(0, (arg1, arg2, arg3, arg4, arg5) => action(new[] { arg1, arg2, arg3, arg4, arg5 }), args[0], args[1], args[2], args[3], args[4]);
                }
            );
        }
        ...
        private static IEnumerable<TestCaseData> PrepareRunInLockFuncCalls()
        {
            ...
            yield return new TestCaseData(
                ...
                {
                    ArgumentNullException.ThrowIfNull(args);
                    return lib.RunInLock(0, (arg1, arg2, arg3) => func(new[] { arg1, arg2, arg3 }), args[0], args[1], args[2]);
                }
            );
            yield return new TestCaseData(
                4,
                ...
                {
                    ArgumentNullException.ThrowIfNull(args);
                    return lib.RunInLock(0, (arg1, arg2, arg3, arg4) => func(new[] { arg1, arg2, arg3, arg4 }), args[0], args[1], args[2], args[3]);
                }
            );
            yield return new TestCaseData(
                5,
                ...
                {
                    ArgumentNullException.ThrowIfNull(args);
                    return lib.RunInLock(0, (arg1, arg2, arg3, arg4, arg5) => func(new[] { arg1, arg2, arg3, arg4, arg5 }), args[0], args[1], args[2], args[3], args[4]);
                }
            );
        }
        ...
        public void RunInLockShouldCallLockActionAndUnlock(int argCount, Action<ISunVoxLib, Action<object[]?>, object[]?> action)
        {
            var lib = Substitute.For<ISunVoxLib>();
            var mockAction = Substitute.For<Action<object[]?>>();
            var mockData = argCount == 0 ? null : Enumerable.Range(0, argCount).Select(static i => (object)i.ToString()).ToArray();
            // when
        ...
        public void RunInLockShouldCallLockFuncAndUnlock(int argCount, Func<ISunVoxLib, Func<object[]?, object>, object[]?, object> function)
        {
            var lib = Substitute.For<ISunVoxLib>();
        ...
        [TestCaseSource(nameof(RunInLockActionCases))]
        public void RunInLockShouldCallLockActionAndUnlockWhenPassedActionThrowsException(int argCount, Action<ISunVoxLib, Action<object[]?>, object[]?> action)
        {
            var lib = Substitute.For<ISunVoxLib>();
        ...
        [TestCaseSource(nameof(RunInLockFuncCases))]
        public void RunInLockShouldCallLockFuncAndUnlockWhenPassedFuncThrowsException(int argCount, Func<ISunVoxLib, Func<object[]?, object>, object[]?, object> function)
        {
            var lib = Substitute.For<ISunVoxLib>();
            var sub = Substitute.For<Action>();
        ...
        [TestCaseSource(nameof(RunInLockActionCases))]
        public void RunInLockForActionShouldCallLockAndNothingElseIfItThrowsException(int argCount, Action<ISunVoxLib, Action<object[]?>, object[]?> action)
        {
            var lib = Substitute.For<ISunVoxLib>();
        ...
        [TestCaseSource(nameof(RunInLockFuncCases))]
        public void RunInLockForFuncShouldCallLockAndNothingElseIfItThrowsException(int argCount, Func<ISunVoxLib, Func<object[]?, object>, object[]?, object> function)
        {
            var lib = Substitute.For<ISunVoxLib>();
            lib.When(static x => x.LockSlot(Arg.Any<int>())).Do(static _ => throw new Exception());
            var mockFunction = Substitute.For<Func<object[]?, object>>();
